...
Begin VB.Form frmMain 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   8
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":0D61
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":0E81
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":0FA1
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":13F5
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":1515
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":1635
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":1791
            Key             =   ""
         EndProperty
   ...
   Begin MSComctlLib.ImageList imgToolbar 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   3
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":2035
            Key             =   "Delete"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":2671
            Key             =   "Up"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
...
Private Sub RefreshLV(Optional ShowFolderSize As Boolean)
  ...
  For i = 0 To Dir1.ListCount - 1 'Add Folders to ListView
    Set thisFolder = fSys.GetFolder(Dir1.List(i))
    r = ExtractIcon(thisFolder.Path, ImgSmall, picBuffer, 16, thisFolder.Type)
    Set LItem = lvDir.ListItems.Add(, Dir1.List(i), thisFolder.Name, , r)
    If ShowFolderSize Then
      LItem.SubItems(1) = Format(thisFolder.Size / 1024, "###,##0") & " KB"
      If i Mod 1 = 0 Then DoEvents 'Update the display
    Else
      LItem.SubItems(1) = " "
      If i Mod 100 = 0 Then DoEvents 'Update the display
    End If
    LItem.SubItems(2) = thisFolder.Type
  Next i
  
  For i = 0 To File1.ListCount - 1 'Add Files to ListView
    FName = File1.Path & IIf(Right(File1.Path, 1) <> "\", "\", "") & File1.List(i)
    ...
    If i Mod 100 = 0 Then lvDir.Refresh
  Next i
  tvDir.Enabled = True
End Sub
...
Private Sub tvDir_Expand(ByVal Node As MSComctlLib.Node)
  ...
  If Node.Child.Text = "" Then
    ...
    For i = 0 To DummyDir.ListCount - 1
      ...
      r = ExtractIcon(DummyDir.Path, ImgSmall, picBuffer, 16, "File Folder")
      tvDir.Nodes.Add DummyDir.Path, tvwChild, DummyDir.List(i), FolderName, 4
      ...
      If CheckForChildDir.ListCount > 0 Then
        ...
        tvDir.Nodes(DummyDir.List(i)).ExpandedImage = 5
      End If
    Next i
  End If
  Dir1.Tag = "Ok 2 Up"
